...
- Integration
  - AI agents need to be integrated with SQL Anywhere, typically through [APIs](AI/ms-dynamics-365/Readme.md) or connectors that allow them to execute SQL commands and retrieve data.
